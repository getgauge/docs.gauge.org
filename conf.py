...
extensions = ['sphinx.ext.todo',
        'sphinx.ext.ifconfig',
        'gauge_lexer',
        'code_lineno_highlighter',
        'tabs',
        'project_setup_filters',
        'gauge_installation',
        'sphinx_sitemap']
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'README.md', "partials", "venv"]
...
site_url = 'https://docs-preview.gauge.org/'
